          ...
          <div class="col-md-10 offset-md-1">
            <div class="card mb-4">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end"><a class="btn btn-sm btn-primary rounded-0" href="{{ route('events.create') }}">Create New Event</a></small>
              </div>
              <div class="card-body">
                <form method="POST" action="{{ route('events.update', $id) }}" enctype="multipart/form-data">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="file" class="dropify form-control @error('thumbnail') is-invalid @enderror" data-default-file="/storage/{{ $thumbnail ?? old('thumbnail') }}" id="basic-default-thumbnail" id="thumbnail" value="{{ old('thumbnail') }}" name="thumbnail" />
