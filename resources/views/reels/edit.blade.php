        ...
        <div class="row">
          <div class="col-md-10 offset-md-1">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form method="POST" action="{{ route('reels.update', $reel->id) }}" enctype="multipart/form-data">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="basic-default-title" value="{{ $reel->title ?? old('title') }}" id="title" name="title" placeholder="Title..." />
                  ...
                  <div class="col-md-6">
                    ...
                    <select class="form-control @error('published') is-invalid @enderror" name="published" id="published">
                        <option value="1" @if ($reel->publish == 1) selected @endif value="1">Publish</option>
                        <option value="0" @if ($reel->publish == 0) selected @endif value="0">Unpublish</option>
                    </select>
