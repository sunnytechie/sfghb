            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-6">
                    <label class="form-label" for="url">Youtube Link</label>
                    <input type="text" class="form-control @error('url') is-invalid @enderror" id="basic-default-url" value="{{ old('url') }}" id="url" name="url" placeholder="url..." />
                  ...
                  <div class="mb-3">
                    ...
                    <input type="file" class="dropify form-control @error('image') is-invalid @enderror" id="basic-default-image" id="image" value="{{ old('image') }}" name="image" />
